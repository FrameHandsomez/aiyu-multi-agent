...
function buildSystemPrompt(agentSpec, skillInstructions, projectProfile, runtimeContext = {}) {
  let prompt = `You are ${agentSpec.name}, an AI agent.\n\n`;
  if (runtimeContext.provider || runtimeContext.model) {
